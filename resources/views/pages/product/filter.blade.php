    ...
    <div class="main-container">
        <div class="row  gutters">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product.filter') }}" method="GET" enctype="multipart/form-data">
                            <div class="row gutters">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label class="" for=" category_id">Category <span
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                    <div class="form-group row">
                                        <label class="" for="brand_id">Brand <span
                                                class="text-danger">*</span></label>
                        ...
                        <div class="active-user-chatting">
                            ...
                            <div class="chat-actions">
                                <a href="{{ route('product.create') }}" class="btn btn-info btn-md">Add
                                    New</a>
                                <a href="{{ route('product.index') }}" class="btn btn-success btn-md">Product</a>
