...
@section('content')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('brand.index') }}">All Brand</a></li>
            <li class="breadcrumb-item"><a href="{{ route('brand.trash_list') }}">Trash List</a></li>
        </ol>
    </div>
                ...
                <div class="table-container">
                    <div class="active-user-chatting">
                        ...
                        <div class="chat-actions">
                            ...
                            <a href="{{ route('brand.trash_list') }}" class="btn btn-danger btn-md">Trash
                                list</a>
                        </div>
                    </div>
                    <div class="table-responsive">

                        <form style="overflow: hidden;" action="{{ route('brand.bulk_action') }}" method="post">
                            @csrf
