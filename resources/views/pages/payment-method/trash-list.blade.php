...
@section('content')
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('payment-method.trash_list') }}">Trash List</a></li>
        </ol>
    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <div class="table-container">
                    ...
                    <div class="table-responsive">
                        <form style="overflow: hidden;" action="{{ route('payment-method.bulk_action') }}" method="post">
                            @csrf
                            ...
                            <table id="print-table100" class="table custom-table">
                                ...
                                <tbody>
                                    @forelse ($allPaymentMethod as $key => $value)
                                        <tr>
