                ...
                <div class="table-container">
                    ...
                    <div class="table-responsive">
                        <table id="print-table100" class="table custom-table">
                            ...
                            <tbody>
                                @foreach ($allPending as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('order.order_update') }}" method="post">
                                                ...
                                                <select name="status">
                                                    <option value="{{ 'draft' }}" @selected($value->status == 'draft')>Draft  </option>
                                                    <option value="{{ 'active' }}" @selected($value->status == 'active')>Active </option>
                                                </select>
                                                <button type="submit" class="btn btn-success btn-sm"><i  class="icon-check2"></i></i></button>
                                            </form>
                                        </td>
